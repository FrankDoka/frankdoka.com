...
The whole pipeline has since grown into its own reusable toolkit. **→ [SpriteForge](/lab/spriteforge)** —
the full process, the wrong turns, the matting maths that finally solved the edges, and how the *same*
character gets re-posed into new stances.
